...
const DEFAULT_IMAGES = [
    ...
    { id: '4', src: ii.suv.src, thumbnail: ii.suv.thumb, fulls: ii.suv.fulls, caption: 'The King of Survivals', description: '简化版H5吃鸡游戏', page: 'https://www.facebook.com/TheKingOfSurvivals/', project: null},
];
